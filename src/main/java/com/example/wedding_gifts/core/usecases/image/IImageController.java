...
public interface IImageController {
    ...
    public ResponseEntity<MessageDTO> insert(UUID accountId, UUID giftId, List<String> images) throws Exception;

    public ResponseEntity<MessageDTO> delete(UUID accountId, UUID giftId, List<UUID> images) throws Exception;
