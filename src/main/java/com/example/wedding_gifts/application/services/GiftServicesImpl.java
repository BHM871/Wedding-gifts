    ...
    public List<Gift> getWithFilter(SearcherDTO searcher) throws Exception {
        ...
        if(searcher.title() != null){
            if(searcher.categories() != null) {
                return repository.getByTitleAndCategoriesOrBought(new SearcherByTitleAndCategoriesDTO(searcher.title(), searcher.categories(), searcher.isBought() != null ? searcher.isBought() : null));
            }
        ...
        if(searcher.categories() != null && (searcher.startPrice() != null || searcher.endPrice() != null)) {
