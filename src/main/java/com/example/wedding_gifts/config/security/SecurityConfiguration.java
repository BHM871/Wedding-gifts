    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.DELETE, "/gift/delete/all").authenticated()
                .requestMatchers(HttpMethod.POST, "/gift/create").authenticated()
                .requestMatchers(HttpMethod.PUT, "/gift/update").authenticated()
                .requestMatchers(HttpMethod.GET, "/image/base64").authenticated()
                .requestMatchers(HttpMethod.PUT, "/image/insert").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/image/delete").authenticated()
                .requestMatchers(HttpMethod.GET, "/payment").authenticated()
                .requestMatchers(HttpMethod.GET, "/payment/aid").authenticated()
